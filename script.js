...
new LeaderLine(document.getElementById("skills"), document.getElementById("projects-header"), { color: "white", size: 3, path: "grid", startSocket: "bottom", endPlug: "behind", dropShadow: { color: "white", dx: 40, dy: 40, blur: 0 } });
